          ...
          <div className="rounded-md shadow-sm -space-y-px">
            ...
            <div>
              ...
              <select
                ...
                name="role"
                required
                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 text-gray-900 rounded-b-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm bg-white"
                value={formData.role}
                onChange={handleChange}
              >
